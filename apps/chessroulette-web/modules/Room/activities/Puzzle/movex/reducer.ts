...
import { Chapter, ChapterState, PuzzleActivityState } from './types';
...
export const findLoadedChapter = (
  activityState: PuzzleActivityState['activityState']
): Chapter | undefined =>
...
export const reducer: MovexReducer<ActivityState, ActivityActions> = (
  ...
  if (prev.activityType !== 'puzzle') {
    return prev;
  }
  // console.log('puzzle', action);
