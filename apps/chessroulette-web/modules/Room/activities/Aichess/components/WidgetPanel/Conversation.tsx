        ...
        return (
          <div key={index} className="mb-4 text-[15px]" >
            {participant == 'chatGPT123456' ? (
             ...
             <p className="flex  items-center justify-end  text-left whitespace-pre-line">{msg.content}</p>  
             </div>
              ...
              <div className="w-9 h-9 rounded-full overflow-hidden bg-gray-200">
                <img src="https://outpostchess.fra1.digitaloceanspaces.com/bfce3526-2133-4ac5-8b16-9c377529f0b6.jpg" alt="Avatar" className="w-full h-full object-cover" />
              </div>
              </div>
                          ) : (
                            <div className="flex">
              ...
              <div className="ml-4 max-w-xs max-w-[80%] bg-[#202122] text-white border border-[#2a2b2d] rounded-xl  py-2 text-sm px-4">
                            <p className="flex  items-center justify-start  text-left whitespace-pre-line">{msg.content}</p>  
              </div>
              </div>
            )}
