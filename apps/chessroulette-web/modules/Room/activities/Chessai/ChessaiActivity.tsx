...
import { useChessaiActivitySettings } from './hooks/useChessaiActivitySettings';
import {
...
import { ChessaiBoard } from './components/ChessaiBoard';
...
type Props = {
  remoteState: ChessaiActivityState['activityState'];
...
export const ChessaiActivity = ({
  remoteState,
  dispatch: optionalDispatch,
}: Props) => {
  const dispatch = optionalDispatch || noop;
  const [cameraOff, setCameraOff] = useState(false);
  const settings = useChessaiActivitySettings();
